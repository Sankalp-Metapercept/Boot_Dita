...
set CLASSPATH=%DITA_DIR%lib\Saxon-HE-12.3.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\ant-apache-resolver-1.10.13.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%lib\jackson-annotations-2.15.2.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-core-2.15.2.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-databind-2.15.2.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-dataformat-yaml-2.15.2.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jing-20181222.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\logback-classic-1.4.8.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\logback-core-1.4.8.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\slf4j-api-2.0.7.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\snakeyaml-2.0.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%lib\xmlresolver-5.2.0-data.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\xmlresolver-5.2.0.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\com.elovirta.pdf\lib\pdf-generator-0.7.0.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\batik-all-1.16.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\fontbox-2.0.28.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\fop-2.8.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\fop-pdf-images-2.8.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\xmlgraphics-commons-2.8.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.xep\lib\xep.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.lwdita\lib\org.lwdita-5.5.0.jar;%CLASSPATH%
